...
// sheet (Sheet2, column D) when they open their personalized confirmed
// page, via the same Apps Script Web App used to save RSVPs. See
// README.md for the doGet setup this relies on.
